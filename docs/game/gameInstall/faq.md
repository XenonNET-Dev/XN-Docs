...
最典型的例子：如果您的显示器比例是 `16:10` ，那您玩的时候会发现车辆好像变扁了，有些 UI 原本应该是圆形的被拉伸成椭圆形。  

:::details 解决方案
前往游戏本体文件夹，找到 `wmn6r.exe` / `wmn5r.exe`  
随后，右键 --> 属性  
在弹出的属性窗口中，前往 “兼容性” 选项卡，然后点击 “更改高 DPI 设置”  
随后，将 “高 DPI 缩放替代” 中的 “替代高 DPI 缩放行为打开”，并将其下拉菜单中的选项调整为 “应用程序”。  
